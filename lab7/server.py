...
while True:
    ...
    # '!i' - network byte order, integer | it means that it works on every machine
    # Gracz 1
    ...
    if int(client1_choice) == 0 or int(client2_choice) == 0:
        ...
        client_scores[client1_adress] = client_scores[client1_adress] + \
            current_score[0]
        client_scores[client2_adress] = client_scores[client2_adress] + \
            current_score[1]
